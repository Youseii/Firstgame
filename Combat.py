...
walkRight = [pygame.image.load('pictures/R1.png'), pygame.image.load('pictures/R2.png'),
             pygame.image.load('pictures/R3.png'), pygame.image.load('pictures/R4.png'),
             pygame.image.load('pictures/R5.png'), pygame.image.load('pictures/R6.png'),
             pygame.image.load('pictures/R7.png'), pygame.image.load('pictures/R8.png'),
             pygame.image.load('pictures/R9.png')]

walkLeft = [pygame.image.load('pictures/L1.png'), pygame.image.load('pictures/L2.png'),
            pygame.image.load('pictures/L3.png'), pygame.image.load('pictures/L4.png'),
            pygame.image.load('pictures/L5.png'), pygame.image.load('pictures/L6.png'),
            pygame.image.load('pictures/L7.png'), pygame.image.load('pictures/L8.png'),
            pygame.image.load('pictures/L9.png')]

#Fond de la fenetre de jeux
zoneDebut = pygame.image.load('pictures/aaa.png')

zonefinal = pygame.image.load('pictures/bbb.png') #Changement de zone

#ATTAQUE DU BOSS DRAGON DE FEU-------------------------------------------------
dragon = pygame.image.load("pictures/spellsprite.png")
#Affichage du personnage
perso = pygame.image.load('pictures/standing.png')
...
#Ajout de song
songtoucher = pygame.mixer.Sound("song/hit.wav")

musique = pygame.mixer.music.load("song/ost.mp3")
pygame.mixer.music.play(-1)


font = pygame.font.SysFont("comicsans", 100)

fin = pygame.image.load('pictures/END.png')
...
class Joueur(object):
    ...
    def toucher(self): #Si le personnage se fait toucher par l"ennemie alors il revien a sa position de base.
        ...
        texte = pygame.image.load("pictures/death.png")
...
class Firedragon(object):
    def __init__(self, x, y):
        self.img=pygame.image.load("pictures/spellsprite.png")
...
class magie(object): #Classe magie pour le magicien qui rest statique et pour peut etre le Boss final
    ...
    mechant = pygame.image.load('pictures/magicien.png')
    boss = pygame.image.load("pictures/BOSS.png") #Boss final
...
class ennemy(object):
    ...
    walkRight = [pygame.image.load('pictures/R1E.png'), pygame.image.load('pictures/R2E.png'),
            pygame.image.load('pictures/R3E.png'), pygame.image.load('pictures/R4E.png'),
            pygame.image.load('pictures/R5E.png'), pygame.image.load('pictures/R6E.png'),
            pygame.image.load('pictures/R7E.png'), pygame.image.load('pictures/R8E.png'),
            pygame.image.load('pictures/R9E.png'), pygame.image.load('pictures/R10E.png'),
            pygame.image.load('pictures/R11E.png')]

    walkLeft = [pygame.image.load('pictures/L1E.png'), pygame.image.load('pictures/L2E.png'),
            pygame.image.load('pictures/L3E.png'), pygame.image.load('pictures/L4E.png'),
            pygame.image.load('pictures/L5E.png'), pygame.image.load('pictures/L6E.png'),
            pygame.image.load('pictures/L7E.png'), pygame.image.load('pictures/L8E.png'),
            pygame.image.load('pictures/L9E.png'), pygame.image.load('pictures/L10E.png'),
            pygame.image.load('pictures/L11E.png')]
